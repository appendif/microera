...
class jimo_sale_report(orm.Model):
    ...
    _columns = {
        ...
        'private_price': fields.float('Private Price', digits=(16, 2), readonly=True),
        'cost_price': fields.float('Cost Price', digits=(16, 2), readonly=True),
        ...
        'it_employee_id': fields.many2one('hr.employee', 'Employee ITA', readonly=True),
...
SELECT
   ...
   (sol.product_uom_qty / u.factor * u2.factor) AS order_qty,
    ...
    sol.purchase_price AS cost_price,
